...
const AllGames = () => {
  ...
  <section id='Games ' >
    <div className='container py-8 min-h-[100vh]'>
      <h2 className='text-white text-4xl font-semibold'>Games</h2>
    {
      isLoading ? 
      <Loading/>
      :
      <>
        ...
        <span className='text-white text-xl mx-5 font-semibold' >{currentPage}</span>
        <button 
        onClick={handleNext} 
        ...
        <div className="grid grid-cols-12 gap-4 mt-5">
          {currentItems?.map((game , index )=> {
           return <div key={index} className="sm:col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-4 border-b-[1px] border-gray-800 pb-3 game-cart">
            ...
            <Link to={game.freetogame_profile_url} className="btn-content flex items-center" target="_blank">
